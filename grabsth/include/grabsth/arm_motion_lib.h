// library for baxter cartesian move commander
// illustrate use of baxter_cart_move_as action server call "cartMoveActionServer"

#ifndef ARM_MOTION_LIB_H_
#define ARM_MOTION_LIB_H_
...
private:
    ros::NodeHandle nh_;
    ros::Publisher a_first_publisher;
    ros::Publisher b_second_publisher;
    ros::Publisher c_third_publisher;
    ros::Publisher d_fourth_publisher;
    ros::Publisher e_first_publisher;
    ros::Publisher f_second_publisher;
    ros::Publisher g_third_publisher;
    ros::Publisher h_fourth_publisher;
